...
file_1 = 'H:\\Data\\dict\\drug2953_dict.txt'
file_2 = 'H:\\Data\\dict\\drug2953_dict.txt'
file_1x2 = 'H:\\Data\\interaction\\drug-drug.txt'
...
file_1x2_list1 = single_column(file_1x2, 0, removetitle=False)
file_1x2_list2 = single_column(file_1x2, 1, removetitle=False)
...
#输出为txt格式
np.savetxt('C:\\Users\\hw\\Desktop\\drug_drug_mat.txt', hello, fmt="%d")
